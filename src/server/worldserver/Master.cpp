...
class WorldServerSignalHandler : public WCloud::SignalHandler
{
    public:
...
int Master::Run()
{
    ...
    sLog->outString("               ,,                                                                                           ");
    sLog->outString("                .                                                                        .         .        ");
    sLog->outString("   :@Hi    ,;:   :@,                                                               s@Sr.;@X G@@r2B5S.       ");
    sLog->outString("    ,@@@s@@@@@@@@@@                            ,.                                   @@@@22;:  #@@           ");
    sLog->outString("     @@@@@@   52@@s  si,;;.XrrrS2        :    95##    ;SXi:      :i.  ;i ., A@H. ,  ,@@@Sr;SS  @h.          ");
    sLog->outString("     @hM@&       hH  .@@H:, @A  @@H@#5@@@r:   ,: @@r2 3Xi@@@@r    X@@@@: r@@@r@@@H   ##@@@ii5  @@2          ");
    sLog->outString("     @9B@:,       ;:, A@@@r @@  @# @@@.s@ :@#rH; i@@@ .@ir#@@@@    @@9,  ,@@9  @@A   @@2B@@2:: @@M          ");
    sLog->outString("     @MH@@@@@@@@@@#5. #3;@@ ;@  A  @@@  M: r@@@  ,@@#  @@XHss&     M@@@   @@@  @@#   2@. H@@S:,,A@          ");
    sLog->outString("     @Hr,sr#@@92.     is B@@.#     M@B      @@A   @Ah  @@9 @@:     #@@S   @@@  @@A   2@r  @@@s. 2@          ");
    sLog->outString("    2@#B:.          ,;A#  s@@@     B@@.     @@H.  S@@,.2A&. @@r    ;@A.   @@X  r@@   s2A   @@@Br@@          ");
    sLog->outString("     @@@@s      :hs ..      #@    ;#@@is:   &A@@@A@X         H@2  ;AH@@s   r@@B@h:;iB@@@r   ;@@@@@          ");
    sLog->outString("       @@@@hrB@MA;           &.        ,:       ;5             @2      .     .r   :::::,:     H@@@          ");
    sLog->outString("         3@@@@,                                                 r                              9@2          ");
    sLog->outString("           .:                                                                                   ;&          ");
    sLog->outString("  Project WCloudEmu 2011(c) Open-sourced Game Emulation ");
    sLog->outString("           <http://www.enturion.com/> ");
    sLog->outString(" ");
