    ...
    struct npc_ring_of_frostAI : public ScriptedAI
    {
        ...
        void InitializeAI()
        {
            ...
            me->GetPosition(x, y, z);
            {
                ...
                WCloud::AllFriendlyCreaturesInGrid check(me);
                WCloud::CreatureListSearcher<WCloud::AllFriendlyCreaturesInGrid> searcher(me, templist, check);

                TypeContainerVisitor<WCloud::CreatureListSearcher<WCloud::AllFriendlyCreaturesInGrid>, GridTypeMapContainer> cSearcher(searcher);
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            WCloud::AnyUnfriendlyUnitInObjectRangeCheck u_check(me, me, 5.0f);
            WCloud::UnitListSearcher<WCloud::AnyUnfriendlyUnitInObjectRangeCheck> searcher(me, targets, u_check);
