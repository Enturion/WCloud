    ...
    public:
        ...
        class spell_gen_cannibalize_SpellScript : public SpellScript
        {
            ...
            SpellCastResult CheckIfCorpseNear()
            {
                ...
                WCloud::AnyDeadUnitSpellTargetInRangeCheck check(caster, max_range, GetSpellInfo(), TARGET_SELECT_CHECK_ENEMY);
                WCloud::WorldObjectSearcher<WCloud::AnyDeadUnitSpellTargetInRangeCheck> searcher(caster, result, check);
