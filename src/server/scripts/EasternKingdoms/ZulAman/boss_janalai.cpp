        ...
        //        DoZoneInCombat();
            ...
            bool HatchAllEggs(uint32 action) //1: reset, 2: isHatching all
            {
...

                {
                    ...
                    WCloud::AllCreaturesOfEntryInRange check(me, MOB_EGG, 100);
                    WCloud::CreatureListSearcher<WCloud::AllCreaturesOfEntryInRange> searcher(me, templist, check);

                    TypeContainerVisitor<WCloud::CreatureListSearcher<WCloud::AllCreaturesOfEntryInRange>, GridTypeMapContainer> cSearcher(searcher);
            ...
            void Boom()
            {
...

                {
                    ...
                    WCloud::AllCreaturesOfEntryInRange check(me, MOB_FIRE_BOMB, 100);
                    WCloud::CreatureListSearcher<WCloud::AllCreaturesOfEntryInRange> searcher(me, templist, check);
        ...
        struct mob_janalai_hatcherAI : public ScriptedAI
        {
            ...
            bool HatchEggs(uint32 num)
            {
...

                {
                    ...
                    WCloud::AllCreaturesOfEntryInRange check(me, 23817, 50);
                    WCloud::CreatureListSearcher<WCloud::AllCreaturesOfEntryInRange> searcher(me, templist, check);
