    ...
    public:
        ...
        struct boss_hodirAI : public BossAI
        {
            ...
            void FlashFreeze()
            {
                ...
                WCloud::AnyUnfriendlyUnitInObjectRangeCheck checker(me, me, 100.0f);
                WCloud::UnitListSearcher<WCloud::AnyUnfriendlyUnitInObjectRangeCheck> searcher(me, TargetList, checker);
            ...
            void UpdateAI(uint32 const diff)
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        {
                            std::list<Unit*> TargetList;
                            WCloud::AnyFriendlyUnitInObjectRangeCheck checker(me, me, 30.0f);
                            WCloud::UnitListSearcher<WCloud::AnyFriendlyUnitInObjectRangeCheck> searcher(me, TargetList, checker);
