...
public:
    ...
    struct boss_sartharionAI : public ScriptedAI
    {
        ...
        void CastLavaStrikeOnTarget(Unit* target)
        {
            ...
            WCloud::AllCreaturesOfEntryInRange checker(me, NPC_FIRE_CYCLONE, 200.0f);
            WCloud::CreatureListSearcher<WCloud::AllCreaturesOfEntryInRange> searcher(me, fireCyclonesList, checker);
