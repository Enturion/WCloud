...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
            ...
            { "wcloud_string",               SEC_ADMINISTRATOR, true,  &HandleReloadWCloudStringCommand,              "", NULL },
    ...
    static bool HandleReloadAllCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        HandleReloadWCloudStringCommand(handler, "");
    ...
    static bool HandleReloadWCloudStringCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->outString("Re-Loading wcloud_string Table!");
        sObjectMgr->LoadWCloudStrings();
        handler->SendGlobalGMSysMessage("DB table `wcloud_string` reloaded.");
        return true;
    }
