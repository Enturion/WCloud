...
void World::LoadConfigSettings(bool reload)
{
    ...
    SetMotd(ConfigMgr::GetStringDefault("Motd", "Welcome to a WCloud Core Server."));
...
void World::SetInitialWorldSettings()
{
    ...
    sLog->outString();
    sLog->outString("Loading WCloud strings...");
    if (!sObjectMgr->LoadWCloudStrings())
...
void World::SendWorldText(int32 string_id, ...)
{
    ...
    WCloud::WorldWorldTextBuilder wt_builder(string_id, &ap);
    WCloud::LocalizedPacketListDo<WCloud::WorldWorldTextBuilder> wt_do(wt_builder);
