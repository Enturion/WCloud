...
void CreatureEventAIMgr::LoadCreatureEventAI_Texts()
{
    ...
    // Load EventAI Text
    sObjectMgr->LoadWCloudStrings("creature_ai_texts", MIN_CREATURE_AI_TEXT_STRING_ID, MAX_CREATURE_AI_TEXT_STRING_ID);
    ...
    do
    {
        ...
        if (!sObjectMgr->GetWCloudStringLocale(i))
        {
...
void CreatureEventAIMgr::LoadCreatureEventAI_Summons()
{
    ...
    do
    {
        ...
        if (!WCloud::IsValidMapCoord(temp.position_x, temp.position_y, temp.position_z, temp.orientation))
        {
