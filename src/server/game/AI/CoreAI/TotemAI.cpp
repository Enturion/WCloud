...
TotemAI::UpdateAI(const uint32 /*diff*/)
{
  if (me->ToTotem()->GetTotemType() != TOTEM_ACTIVE)
    ...
    {
        victim = NULL;
        WCloud::NearestAttackableUnitInObjectRangeCheck u_check(me, me, max_range);
        WCloud::UnitLastSearcher<WCloud::NearestAttackableUnitInObjectRangeCheck> checker(me, victim, u_check);
