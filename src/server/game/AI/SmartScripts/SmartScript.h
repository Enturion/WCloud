...
class SmartScript
{
    public:
        ...
        Creature* FindCreatureNear(WorldObject* searchObject, uint32 guid) const
        {
            ...
            WCloud::CreatureWithDbGUIDCheck target_check(searchObject, guid);
            WCloud::CreatureSearcher<WCloud::CreatureWithDbGUIDCheck> checker(searchObject, creature, target_check);
