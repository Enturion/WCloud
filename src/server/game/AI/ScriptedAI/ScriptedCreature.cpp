...
std::list<Creature*> ScriptedAI::DoFindFriendlyCC(float range)
{
    ...
    WCloud::CreatureListSearcher<WCloud::FriendlyCCedInRange> searcher(me, list, u_check);
    me->VisitNearbyObject(range, searcher);
    return list;
}
...
{
    std::list<Creature*> list;
    WCloud::FriendlyMissingBuffInRange u_check(me, range, uiSpellid);
...
Player* ScriptedAI::GetPlayerAtMinimumRange(float minimumRange)
{
    ...
    CellCoord pair(WCloud::ComputeCellCoord(me->GetPositionX(), me->GetPositionY()));
    Cell cell(pair);
    cell.SetNoCreate();

    WCloud::PlayerAtMinimumRangeAway check(me, minimumRange);
    WCloud::PlayerSearcher<WCloud::PlayerAtMinimumRangeAway> searcher(me, player, check);
    TypeContainerVisitor<WCloud::PlayerSearcher<WCloud::PlayerAtMinimumRangeAway>, GridTypeMapContainer> visitor(searcher);
