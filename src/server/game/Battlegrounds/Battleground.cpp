...
namespace WCloud
{
    class BattlegroundChatBuilder
    {
        public:
            ...
            {
                char const* text = sObjectMgr->GetWCloudString(_textId, loc_idx);
                if (_args)
                {
    ...
    class Battleground2ChatBuilder
    {
        public:
            ...
            {
                char const* text = sObjectMgr->GetWCloudString(_textId, loc_idx);
                char const* arg1str = _arg1 ? sObjectMgr->GetWCloudString(_arg1, loc_idx) : "";
                char const* arg2str = _arg2 ? sObjectMgr->GetWCloudString(_arg2, loc_idx) : "";
...
uint32 Battleground::GetBonusHonorFromKill(uint32 kills) const
{
    ...
    return WCloud::Honor::hk_honor_at_level(maxLevel, float(kills));
}
...
void Battleground::SendMessageToAll(int32 entry, ChatMsg type, Player const* source)
{
    ...
    WCloud::BattlegroundChatBuilder bg_builder(type, entry, source);
    WCloud::LocalizedPacketDo<WCloud::BattlegroundChatBuilder> bg_do(bg_builder);
...
void Battleground::PSendMessageToAll(int32 entry, ChatMsg type, Player const* source, ...)
{
    ...
    WCloud::BattlegroundChatBuilder bg_builder(type, entry, source, &ap);
    WCloud::LocalizedPacketDo<WCloud::BattlegroundChatBuilder> bg_do(bg_builder);
    BroadcastWorker(bg_do);
...
void Battleground::SendWarningToAll(int32 entry, ...)
{
    ...
    const char *format = sObjectMgr->GetWCloudStringForDBCLocale(entry);
...
{
    WCloud::Battleground2ChatBuilder bg_builder(type, entry, source, arg1, arg2);
    WCloud::LocalizedPacketDo<WCloud::Battleground2ChatBuilder> bg_do(bg_builder);
    BroadcastWorker(bg_do);
}
...
// To be removed
const char* Battleground::GetWCloudString(int32 entry)
{
