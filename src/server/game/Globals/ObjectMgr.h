...
// WCloud string ranges
#define MIN_SKYFIRE_STRING_ID           1                    // 'wcloud_string'
...
// WCloud Trainer Reference start range
#define TRINITY_TRAINER_START_REF      200000

struct WCloudStringLocale
{
...
typedef UNORDERED_MAP<int32, WCloudStringLocale> WCloudStringLocaleMap;
...
class ObjectMgr
{
    ...
    public:
        ...
        bool LoadWCloudStrings(char const* table, int32 min_value, int32 max_value);
        bool LoadWCloudStrings() { return LoadWCloudStrings("wcloud_string", MIN_SKYFIRE_STRING_ID, MAX_SKYFIRE_STRING_ID); }
        ...
        WCloudStringLocale const* GetWCloudStringLocale(int32 entry) const
        {
            WCloudStringLocaleMap::const_iterator itr = mWCloudStringLocaleMap.find(entry);
            if (itr == mWCloudStringLocaleMap.end()) return NULL;
            return &itr->second;
        }
        const char *GetWCloudString(int32 entry, LocaleConstant locale_idx) const;
        const char *GetWCloudStringForDBCLocale(int32 entry) const { return GetWCloudString(entry, DBCLocaleIndex); }
...
//        GraveYardMap        mGraveYardMap;
    ...
    private:
        ...
        WCloudStringLocaleMap mWCloudStringLocaleMap;
...
bool LoadWCloudStrings(char const* table, int32 start_value = MAX_CREATURE_AI_TEXT_STRING_ID, int32 end_value = std::numeric_limits<int32>::min());
