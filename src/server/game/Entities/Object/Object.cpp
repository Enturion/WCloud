...
void WorldObject::GetRandomPoint(const Position &pos, float distance, float &rand_x, float &rand_y, float &rand_z) const
{
    ...
    WCloud::NormalizeMapCoord(rand_x);
    WCloud::NormalizeMapCoord(rand_y);
...
{
    return WCloud::IsValidMapCoord(m_positionX, m_positionY, m_positionZ, m_orientation);
}
...
namespace WCloud
{
    class MonsterChatBuilder
    {
        public:
            ...
            {
                char const* text = sObjectMgr->GetWCloudString(i_textId, loc_idx);
...
{
    CellCoord p = WCloud::ComputeCellCoord(GetPositionX(), GetPositionY());

    Cell cell(p);
    cell.SetNoCreate();

    WCloud::MonsterCustomChatBuilder say_build(*this, CHAT_MSG_MONSTER_SAY, text, language, TargetGuid);
    WCloud::LocalizedPacketDo<WCloud::MonsterCustomChatBuilder> say_do(say_build);
    WCloud::PlayerDistWorker<WCloud::LocalizedPacketDo<WCloud::MonsterCustomChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY), say_do);
    TypeContainerVisitor<WCloud::PlayerDistWorker<WCloud::LocalizedPacketDo<WCloud::MonsterCustomChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterSay(int32 textId, uint32 language, uint64 TargetGuid)
{
    ...
    WCloud::MonsterChatBuilder say_build(*this, CHAT_MSG_MONSTER_SAY, textId, language, TargetGuid);
    WCloud::LocalizedPacketDo<WCloud::MonsterChatBuilder> say_do(say_build);
    WCloud::PlayerDistWorker<WCloud::LocalizedPacketDo<WCloud::MonsterChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY), say_do);
    TypeContainerVisitor<WCloud::PlayerDistWorker<WCloud::LocalizedPacketDo<WCloud::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
    cell.Visit(p, message, *GetMap(), *this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY));
}
...
void WorldObject::MonsterYell(const char* text, uint32 language, uint64 TargetGuid)
{
    ...
    WCloud::MonsterCustomChatBuilder say_build(*this, CHAT_MSG_MONSTER_YELL, text, language, TargetGuid);
    WCloud::LocalizedPacketDo<WCloud::MonsterCustomChatBuilder> say_do(say_build);
    WCloud::PlayerDistWorker<WCloud::LocalizedPacketDo<WCloud::MonsterCustomChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_YELL), say_do);
    TypeContainerVisitor<WCloud::PlayerDistWorker<WCloud::LocalizedPacketDo<WCloud::MonsterCustomChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterYell(int32 textId, uint32 language, uint64 TargetGuid)
{
    ...
    WCloud::MonsterChatBuilder say_build(*this, CHAT_MSG_MONSTER_YELL, textId, language, TargetGuid);
    WCloud::LocalizedPacketDo<WCloud::MonsterChatBuilder> say_do(say_build);
    WCloud::PlayerDistWorker<WCloud::LocalizedPacketDo<WCloud::MonsterChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_YELL), say_do);
    TypeContainerVisitor<WCloud::PlayerDistWorker<WCloud::LocalizedPacketDo<WCloud::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
    cell.Visit(p, message, *GetMap(), *this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_YELL));
}
...
void WorldObject::MonsterTextEmote(int32 textId, uint64 TargetGuid, bool IsBossEmote)
{
    ...
    WCloud::MonsterChatBuilder say_build(*this, IsBossEmote ? CHAT_MSG_RAID_BOSS_EMOTE : CHAT_MSG_MONSTER_EMOTE, textId, LANG_UNIVERSAL, TargetGuid);
    WCloud::LocalizedPacketDo<WCloud::MonsterChatBuilder> say_do(say_build);
    WCloud::PlayerDistWorker<WCloud::LocalizedPacketDo<WCloud::MonsterChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_TEXTEMOTE), say_do);
    TypeContainerVisitor<WCloud::PlayerDistWorker<WCloud::LocalizedPacketDo<WCloud::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterWhisper(int32 textId, uint64 receiver, bool IsBossWhisper)
{
    ...
    LocaleConstant loc_idx = player->GetSession()->GetSessionDbLocaleIndex();
    char const* text = sObjectMgr->GetWCloudString(textId, loc_idx);
...
{
    WCloud::MessageDistDeliverer notifier(this, data, dist);
    VisitNearbyWorldObject(dist, notifier);
}

void WorldObject::SendMessageToSet(WorldPacket* data, Player const* skipped_rcvr)
{
    WCloud::MessageDistDeliverer notifier(this, data, GetVisibilityRange(), false, skipped_rcvr);
...
Creature* WorldObject::FindNearestCreature(uint32 entry, float range, bool alive) const
{
    ...
    WCloud::NearestCreatureEntryWithLiveStateInObjectRangeCheck checker(*this, entry, alive, range);
    WCloud::CreatureLastSearcher<WCloud::NearestCreatureEntryWithLiveStateInObjectRangeCheck> searcher(this, creature, checker);
...
{
    GameObject* go = NULL;
    WCloud::NearestGameObjectEntryInObjectRangeCheck checker(*this, entry, range);
    WCloud::GameObjectLastSearcher<WCloud::NearestGameObjectEntryInObjectRangeCheck> searcher(this, go, checker);
...
{
    CellCoord pair(WCloud::ComputeCellCoord(this->GetPositionX(), this->GetPositionY()));
    Cell cell(pair);
    cell.SetNoCreate();

    WCloud::AllGameObjectsWithEntryInRange check(this, entry, maxSearchRange);
    WCloud::GameObjectListSearcher<WCloud::AllGameObjectsWithEntryInRange> searcher(this, gameobjectList, check);
    TypeContainerVisitor<WCloud::GameObjectListSearcher<WCloud::AllGameObjectsWithEntryInRange>, GridTypeMapContainer> visitor(searcher);
...
void WorldObject::GetCreatureListWithEntryInGrid(std::list<Creature*>& creatureList, uint32 entry, float maxSearchRange) const
{
    ...
    WCloud::AllCreaturesOfEntryInRange check(this, entry, maxSearchRange);
    WCloud::CreatureListSearcher<WCloud::AllCreaturesOfEntryInRange> searcher(this, creatureList, check);
    TypeContainerVisitor<WCloud::CreatureListSearcher<WCloud::AllCreaturesOfEntryInRange>, GridTypeMapContainer> visitor(searcher);
...
void WorldObject::GetNearPoint2D(float &x, float &y, float distance2d, float absAngle) const
{
    ...
    WCloud::NormalizeMapCoord(x);
    WCloud::NormalizeMapCoord(y);
}
...
void WorldObject::GetNearPoint(WorldObject const* /*searcher*/, float &x, float &y, float &z, float searcher_size, float distance2d, float absAngle) const
{
    ...
    // adding used positions around object
    {
        ...
        WCloud::NearUsedPosDo u_do(*this, searcher, absAngle, selector);
        WCloud::WorldObjectWorker<WCloud::NearUsedPosDo> worker(this, u_do);

        TypeContainerVisitor<WCloud::WorldObjectWorker<WCloud::NearUsedPosDo>, GridTypeMapContainer  > grid_obj_worker(worker);
        TypeContainerVisitor<WCloud::WorldObjectWorker<WCloud::NearUsedPosDo>, WorldTypeMapContainer > world_obj_worker(worker);
...
void WorldObject::MovePosition(Position &pos, float dist, float angle)
{
    ...
    WCloud::NormalizeMapCoord(pos.m_positionX);
    WCloud::NormalizeMapCoord(pos.m_positionY);
...
void WorldObject::DestroyForNearbyPlayers()
{
    ...
    WCloud::AnyPlayerInObjectRangeCheck check(this, GetVisibilityRange(), false);
    WCloud::PlayerListSearcher<WCloud::AnyPlayerInObjectRangeCheck> searcher(this, targets, check);
...
void WorldObject::UpdateObjectVisibility(bool /*forced*/)
{
    ...
    WCloud::VisibleChangesNotifier notifier(*this);
    VisitNearbyWorldObject(GetVisibilityRange(), notifier);
}
