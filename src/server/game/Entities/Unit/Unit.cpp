...
void Unit::CalcAbsorbResist(Unit* victim, SpellSchoolMask schoolMask, DamageEffectType damagetype, uint32 const damage, uint32* absorb, uint32* resist, SpellInfo const* spellInfo)
{
    ...
    vSchoolAbsorbCopy.sort(WCloud::AbsorbAuraOrderPred());
...
Unit* Unit::SelectNearbyTarget(float dist) const
{
    ...
    WCloud::AnyUnfriendlyUnitInObjectRangeCheck u_check(this, this, dist);
    WCloud::UnitListSearcher<WCloud::AnyUnfriendlyUnitInObjectRangeCheck> searcher(this, targets, u_check);
...
void Unit::UpdateObjectVisibility(bool forced)
{
    ...
    else
    {
        ...
        WCloud::AIRelocationNotifier notifier(*this);
...
bool Unit::UpdatePosition(float x, float y, float z, float orientation, bool teleport)
{
    ...
    if (!WCloud::IsValidMapCoord(x, y, z, orientation))
    {
