        ...
        case GO_READY:
        {
            ...
            if (isSpawned())
            {
                ...
                if (goInfo->type == GAMEOBJECT_TYPE_TRAP)
                {
                    ...
                    {
                        WCloud::AnyUnfriendlyNoTotemUnitInObjectRangeCheck checker(this, owner, radius);
                        WCloud::UnitSearcher<WCloud::AnyUnfriendlyNoTotemUnitInObjectRangeCheck> searcher(this, ok, checker);
                    ...
                    else                                        // environmental trap
                    {
                        ...
                        // affect only players
                        Player* player = NULL;
                        WCloud::AnyPlayerInObjectRangeCheck checker(this, radius);
                        WCloud::PlayerSearcher<WCloud::AnyPlayerInObjectRangeCheck> searcher(this, player, checker);
...
void GameObject::TriggeringLinkedGameObject(uint32 trapEntry, Unit* target)
{
    ...
    GameObject* trapGO = NULL;
    {
        ...
        WCloud::NearestGameObjectEntryInObjectRangeCheck go_check(*target, trapEntry, range);
        WCloud::GameObjectLastSearcher<WCloud::NearestGameObjectEntryInObjectRangeCheck> checker(this, trapGO, go_check);

        TypeContainerVisitor<WCloud::GameObjectLastSearcher<WCloud::NearestGameObjectEntryInObjectRangeCheck>, GridTypeMapContainer > object_checker(checker);
...
GameObject* GameObject::LookupFishingHoleAround(float range)
{
    ...
    WCloud::NearestGameObjectFishingHole u_check(*this, range);
    WCloud::GameObjectSearcher<WCloud::NearestGameObjectFishingHole> checker(this, ok, u_check);

    TypeContainerVisitor<WCloud::GameObjectSearcher<WCloud::NearestGameObjectFishingHole>, GridTypeMapContainer > grid_object_checker(checker);
