...
void Creature::DoFleeToGetAssistance()
{
    ...
    if (radius >0)
    {
        ...
        Cell cell(p);
        cell.SetNoCreate();
        WCloud::NearestAssistCreatureInCreatureRangeCheck u_check(this, getVictim(), radius);
        WCloud::CreatureLastSearcher<WCloud::NearestAssistCreatureInCreatureRangeCheck> searcher(this, creature, u_check);

        TypeContainerVisitor<WCloud::CreatureLastSearcher<WCloud::NearestAssistCreatureInCreatureRangeCheck>, GridTypeMapContainer > grid_creature_searcher(searcher);
...
Unit* Creature::SelectNearestTarget(float dist) const
{
...

    {
        ...
        WCloud::NearestHostileUnitCheck u_check(this, dist);
        WCloud::UnitLastSearcher<WCloud::NearestHostileUnitCheck> searcher(this, target, u_check);

        TypeContainerVisitor<WCloud::UnitLastSearcher<WCloud::NearestHostileUnitCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
        TypeContainerVisitor<WCloud::UnitLastSearcher<WCloud::NearestHostileUnitCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
...
Unit* Creature::SelectNearestTargetInAttackDistance(float dist) const
{
    ...
    {
        WCloud::NearestHostileUnitInAttackDistanceCheck u_check(this, dist);
        WCloud::UnitLastSearcher<WCloud::NearestHostileUnitInAttackDistanceCheck> searcher(this, target, u_check);

        TypeContainerVisitor<WCloud::UnitLastSearcher<WCloud::NearestHostileUnitInAttackDistanceCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
        TypeContainerVisitor<WCloud::UnitLastSearcher<WCloud::NearestHostileUnitInAttackDistanceCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
...
Player* Creature::SelectNearestPlayer(float distance) const
{
    ...
    WCloud::NearestPlayerInObjectRangeCheck checker(this, distance);
    WCloud::PlayerLastSearcher<WCloud::NearestPlayerInObjectRangeCheck> searcher(this, target, checker);
    ...
    if (!m_AlreadyCallAssistance && getVictim() && !isPet() && !isCharmed())
    {
        ...
        if (radius > 0)
        {
...

            {
                ...
                WCloud::AnyAssistCreatureInRangeCheck u_check(this, getVictim(), radius);
                WCloud::CreatureListSearcher<WCloud::AnyAssistCreatureInRangeCheck> searcher(this, assistList, u_check);

                TypeContainerVisitor<WCloud::CreatureListSearcher<WCloud::AnyAssistCreatureInRangeCheck>, GridTypeMapContainer >  grid_creature_searcher(searcher);
...
void Creature::CallForHelp(float radius)
{
    ...
    WCloud::CallOfHelpCreatureInRangeDo u_do(this, getVictim(), radius);
    WCloud::CreatureWorker<WCloud::CallOfHelpCreatureInRangeDo> worker(this, u_do);

    TypeContainerVisitor<WCloud::CreatureWorker<WCloud::CallOfHelpCreatureInRangeDo>, GridTypeMapContainer >  grid_creature_searcher(worker);
...
void Creature::SetPosition(float x, float y, float z, float o)
{
    ...
    if (!WCloud::IsValidMapCoord(x, y, z, o))
    {
