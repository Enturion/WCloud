...
bool BfCapturePoint::Update(uint32 diff)
{
    ...
    WCloud::AnyPlayerInObjectRangeCheck checker(m_capturePoint, radius);
    WCloud::PlayerListSearcher < WCloud::AnyPlayerInObjectRangeCheck > searcher(m_capturePoint, players, checker);
