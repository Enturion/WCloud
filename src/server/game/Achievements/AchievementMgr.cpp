...
void AchievementMgr::SendAchievementEarned(AchievementEntry const* achievement) const
{
    ...
    {
        WCloud::AchievementChatBuilder say_builder(*GetPlayer(), CHAT_MSG_GUILD_ACHIEVEMENT, LANG_ACHIEVEMENT_EARNED, achievement->ID);
        WCloud::LocalizedPacketDo<WCloud::AchievementChatBuilder> say_do(say_builder);
    ...
    else if (GetPlayer()->IsInWorld())
    {
        ...
        WCloud::AchievementChatBuilder say_builder(*GetPlayer(), CHAT_MSG_ACHIEVEMENT, LANG_ACHIEVEMENT_EARNED, achievement->ID);
        WCloud::LocalizedPacketDo<WCloud::AchievementChatBuilder> say_do(say_builder);
        WCloud::PlayerDistWorker<WCloud::LocalizedPacketDo<WCloud::AchievementChatBuilder> > say_worker(GetPlayer(), sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY), say_do);
        TypeContainerVisitor<WCloud::PlayerDistWorker<WCloud::LocalizedPacketDo<WCloud::AchievementChatBuilder> >, WorldTypeMapContainer > message(say_worker);
