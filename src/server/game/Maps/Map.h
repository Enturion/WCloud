...
class MapInstanced;
class InstanceMap;
namespace WCloud { struct ObjectUpdater; }
...
class Map : public GridRefManager<NGridType>
{
    ...
    public:
        ...
        void VisitNearbyCellsOf(WorldObject* obj, TypeContainerVisitor<WCloud::ObjectUpdater, GridTypeMapContainer> &gridVisitor, TypeContainerVisitor<WCloud::ObjectUpdater, WorldTypeMapContainer> &worldVisitor);
        ...
        {
            return IsGridLoaded(WCloud::ComputeGridCoord(x, y));
        }
