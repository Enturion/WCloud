...
CREATE TABLE `character_version` (
  `core_version` varchar(120) NOT NULL DEFAULT 'WCloudEMU Rebase 4.0.6a' COMMENT 'Core revision dumped at startup.',
  `required_2011_12_02_02_characters_version_test` bit(1) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='Version Notes';
INSERT INTO `character_version` VALUES ('WCloudEMU Rebase 4.0.6a', '');
